                        ...
                        <div className="bg-white rounded-[2rem] p-4 md:p-8 shadow-sm border border-slate-200 mb-16">
                            <div className="grid lg:grid-cols-2 gap-12 items-center">
                                ...
                                <div>
                                    ...
                                    <a href="#" className="bg-church-dark text-white px-6 py-3 rounded-full font-medium hover:bg-church-accent transition-colors inline-flex items-center gap-2">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {pastSeries.map((series, i) => (
                            <Reveal key={series.id} delay={i * 100}>
                                <a href="#" className="group block bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-200 hover:shadow-xl hover:border-church-accent transition-all">
